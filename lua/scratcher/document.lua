...
function Document:is_loaded() return type(self.buf) == "number" and api.nvim_buf_is_loaded(self.buf) end
...
function Document:save() api.nvim_buf_call(self:buffer(), vim.cmd.update) end
